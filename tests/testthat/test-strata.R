...
test_that("Example for create_strata works", {
...
test_that("Naming convention of create_strata works with NA", {
  strata <- create_strata(
    depths_shallow = c(55, 75, 100, 125),
    depths_deep = c(200, 250, 300, 350),
    lats_south = c(32, 32, 40, 40),
    lats_north = c(40, 40, 49, 44)
  )
  expect_equal(
    ignore_attr = FALSE,
    strata[["name"]],
...
test_that("Naming convention of create_strata works with NA interspersed", {
  strata <- create_strata(
    names = c("aa", "bb", NA, "cc"),
    depths_shallow = c(55, 75, 100, 125),
    depths_deep = c(200, 250, 300, 350),
...
test_that("create_strata throws errors", {
  expect_error(create_strata(
    names = c("aa", "bb", NA, "cc"),
    depths_shallow = c(5, 75, 100, 125),
    depths_deep = c(200, 250, 300, 350),
    lats_south = c(32, 32, 40, 40),
    lats_north = c(40, 40, 49, 44)
  ))
  expect_error(create_strata(
    names = c(NA, NA, "cc"),
    depths_shallow = c(50, 75, 100, 125),
    depths_deep = c(200, 250, 300, 350),
    lats_south = c(32, 32, 40, 40),
    lats_north = c(40, 40, 49, 44)
  ))
