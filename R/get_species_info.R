...
get_species_info <- function(species, unident = FALSE, verbose = TRUE) {
  ...
  spplist <- t(data.frame(
    ...
    c("coast", "kelp_greenling", "other"),
    c("coast", "lingcod", "other"),
    c("north", "lingcod_north", "other"),
    c("south", "lingcod_south", "other"),
    ...
    c("coast", "redstripe_rockfish", "sloperock"),
    ...
    c("coast", "rougheye_and_blackspotted_rockfish", "sloperock"),
    c("coast", "rougheye_and_blackspotted_rockfish", "sloperock"),
    c("sablefish", "sablefish", "other"),
    c("coast", "sharpchin_rockfish", "sloperock"),
    c("coast", "silvergray rockfish", "shelfrock"),
    ...
    c("coast", "vermilion_rockfish", "shelfrock"),
    c("coast", "vermilion_and_sunset_rockfish", "shelfrock"),
    c("coast", "widow_rockfish", "shelfrock"),
    c("coast", "yelloweye_rockfish", "shelfrock"),
    c("coast", "yellowmouth_rockfish", "shelfrock"),
    c("north_south", "yellowtail_rockfish", "shelfrock"),
    c("north", "yellowtail_rockfish_north", "shelfrock"),
    c("south", "yellowtail_rockfish_north", "shelfrock")
  ))
  ...
  if (length(index) > 0 && lapply(index, length) > 1) {
