...
PullBio.fn <- function (Species = "Sebastes pinniger", YearRange = c(1000, 5000), SurveyName = NULL, SaveFile = FALSE, Dir = NULL) 
{
    ...
    if(SaveFile){
        ...
        save(Data, file = paste0(Dir, "/Bio_", time, "_", SurveyName, "_",  time, ".rda"))
