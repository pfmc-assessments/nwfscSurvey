...
getN <- function(dir, file, type, survey, headerRow = "default", species = "flatfish", printfolder = "forSS"){
	...
	if (!check) { print("The survey name must be speciefied. Options are: NWFSC, Tri.Shelf, AFSC.Slope")}
