...
#'
#' @param strata_df A data frame describing the strata names and boundaries.
...
#' @seealso
#' See \code{\link{create_strata}} for a wrapper to this function.
#' @examples
#' area_example <- get_strata_areas(data.frame(
#'   name = LETTERS[1:8],
...
#' ))
#' # setNames(round(area_example[["area"]], 0), area_example[["name"]])
#' #    A    B    C    D    E    F    G    H
