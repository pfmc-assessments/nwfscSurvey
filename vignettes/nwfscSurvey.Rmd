...
* Create unexpanded conditional age-at-length composition data for used in Stock Synthesis.
...
Plot the coastwided design-based index of abundance:
```r
PlotBio.fn(
  dir = getwd(), 
  dat = biomass)
```
Plot the coastwided design-based index of abundance for each strata:
```r
PlotBioStrata.fn(
  dir = getwd(), 
  dat = biomass)
