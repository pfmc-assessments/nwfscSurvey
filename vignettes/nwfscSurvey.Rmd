...
There are a number of additional plotting functions that users should explore to understand their data: `plot_bio_patterns()`, `plot_cpue()`, `plot_length_age()`, `plot_sex_ratio()`, `plot_sex_ratio_strata()`, `plot_var_length_at_age()`and `plot_weight_length()`.
