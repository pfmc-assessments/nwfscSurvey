...
- [`Format.AKSlope.fn()`](Format.AKSlope.fn.md) : Deprecated function
  replaced by pull_catch() and pull_bio()
...
- [`ReadInAges.fn()`](ReadInAges.fn.md) : Deprecated function replaced
  by pull_bio()

- [`ReadInLengths.fn()`](ReadInLengths.fn.md) : Deprecated function
  replaced by pull_bio()
...
- [`plot_westcoast()`](plot_westcoast.md) :
  ...
  Plot the United States west coast using
